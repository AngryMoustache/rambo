...
window.Link = _tiptap_extension_link__WEBPACK_IMPORTED_MODULE_4__["default"]; // Triggered from Livewire when selecting

window.addEventListener('load-cropper', function (e) {
  window.cropper = new Cropper(document.getElementById('cropper'), _objectSpread(_objectSpread({}, e.detail.options), {}, {
    viewMode: 1,
    dragMode: 'move',
...
__webpack_require__(/*! C:\laragon\www\mobileart-2\vendor\angry-moustache\rambo\resources\js\index.js */"./resources/js/index.js");
module.exports = __webpack_require__(/*! C:\laragon\www\mobileart-2\vendor\angry-moustache\rambo\resources\css\app.scss */"./resources/css/app.scss");
